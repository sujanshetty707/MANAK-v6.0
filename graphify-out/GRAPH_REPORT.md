...
## Corpus Check
- 105 files · ~96,070 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 623 nodes · 1137 edges · 53 communities (37 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7b42caae`
...
Cohesion: 0.19
Nodes (16): ConsumerLoginScreen(), { apiKey, projectId }, firebaseApp, firebaseAuth, firebaseConfig, getStoredFirebaseConfig(), formatIndianPhoneNumber(), getFirebaseErrorMessage() (+8 more)
...
Cohesion: 0.12
Nodes (27): AppContextType, MOCK_CONSUMER_REPORTS, MOCK_HISTORY, REPEAT_VIOLATOR_HEATMAP, SAMPLE_PRODUCTS, COMPLIANCE_RULES, RULE_32_PENALTY_RATE, getRelevantProductImage() (+19 more)
...
### Community 52 - "api.ts"
Cohesion: 0.09
Nodes (45): @supabase/supabase-js, Props, ServerSettingsModal(), ComplianceChatScreen(), ConsumerStatementText(), AppProvider(), supabase, askComplianceChatApi() (+37 more)
...
- **Should `AppContext.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.11469979296066253 - nodes in this community are weakly interconnected._
